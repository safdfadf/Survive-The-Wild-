...
{
   // this script will handle player stats : health, stamina , energy
   [Header("vital stats")]
   ...
   [Header("FoodStats")]
   [SerializeField] private float maxProtein;
   ...
   public void RestoreEnergy(float amount)// when player will sleep energy will restore 
   {
