...
public class CraftingHandler : MonoBehaviour
{
  ...
  [SerializeField] private GameObject craftingUI;// game object on which crafting will happen
  [Header("Testing")]
  [SerializeField] private CraftingSO testingSo;
  ...
  public void ToggleCrafting()
  {
    ...
    craftingUI.SetActive(enableCrafting);
  ...
  { 
    ...
    GameObject result = Instantiate(prefab, craftingUI.transform.position + Vector3.up * 0.2f, Quaternion.identity);
  ...
  private void AddIngredient(Resource<ResourceSo> baseResource)
  {
    ...
    else
    {
      ...
      baseResource.gameObject.transform.SetParent(craftingUI.transform);
      baseResource.transform.SetParent(craftingUI.transform,false);
